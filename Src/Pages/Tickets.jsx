...
export default function Tickets() {
  ...
  return (
    <section style={{ backgroundColor: "#000", color: "#FFD700", minHeight: "100vh", padding: "2rem" }}>
      ...
      <button onClick={resetTickets} style={{ marginBottom: "1rem", padding: "0.5rem 1rem", backgroundColor: "#FFD700", color: "#000", border: "none", borderRadius: "6px", cursor: "pointer" }}>Resetear Boletos</button>
